...
public class FortuneTeller extends JPanel implements Runnable, MouseListener {
	...
	static void begin() {
		...
		JOptionPane.showMessageDialog(null, "Welcome. The hint for the secret locaction is somewhere in the middle.");
	}
	...
	public void mousePressed(MouseEvent e) {
		...
		if (areClose(mouseX, secretLocationX) && areClose(mouseY, secretLocationY)) {
			...
			String Question = JOptionPane
					.showInputDialog("Enter a question for the magic 8 ball.(A Yes or No question)");
